...
\tabx{c L}
\tbf{Currently using:}      & Kotlin, C++, Go \\
\tbf{Well familiar with:}   & Java, Rust, Bash, Haskell \\
\tbf{Had some experience:}  & Scala, Python \\
\end{tabularx}
...
\tbf{vSphere plugin for}    & Currently working on support of creating new VMs from Packer \\
\tbf{Hashicorp Packer}      & in VMware vSphere. \\
\end{tabularx}
